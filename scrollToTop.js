(function ($) {
    $.fn.scrollToTop = function (options) {
        var defaults = {
			...
			targetNodeText: "top",/* targetNode 的文本 */ //&and; 
			targetNodeTitle: "Back to Top",/* targetNode 的文本 */ //&and; 
            ...
            easingType: "easeOutQuart",/* scroll 的轨迹 */
			/********** 样式属性设置 **********/
			...
			/********** targetNode 里 icon 样式 **********/
			targetIconBrWidth: 8,
			targetIconBrColor: "#aaa",
